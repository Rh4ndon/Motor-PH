...
public class App 
{
    ...
    static int rice_subsidy = 1500;
    static int phone_allowance = 1000;
    static int clothing_allowance = 1000;
    static int total_perks = (phone_allowance + rice_subsidy + clothing_allowance);
    ...
    public static void print_details()
    {
        ...
        System.out.printf("-----------------------------------------------%n");
        System.out.printf("| %-20s | %-20s |%n", "Gross income:", gross);
        System.out.printf("-----------------------------------------------%n");
        System.out.printf("| %-20s | %-20s |%n", "Total perks:", total_perks/4);
        System.out.printf("-----------------------------------------------%n");
        System.out.printf("| %-20s | %-20s |%n", "Net Income:", net);
        System.out.printf("-----------------------------------------------%n");

        System.out.printf("\n");
        System.out.printf(" >> Deductions%n");
        System.out.printf("-----------------------------------------------%n");
        System.out.printf("| %-20s | %-20s |%n", "SSS:", sss);
        System.out.printf("-----------------------------------------------%n");
        System.out.printf("| %-20s | %-20s |%n", "Pagibig:", pagibig);
        System.out.printf("-----------------------------------------------%n");
        System.out.printf("| %-20s | %-20s |%n", "Philhealth:", phealth);
        System.out.printf("-----------------------------------------------%n");
        System.out.printf("| %-20s | %-20s |%n", "Witholding Tax:", withholding);
        System.out.printf("-----------------------------------------------%n");
        System.out.printf("| %-20s | %-20s |%n", "Total Deductions:", deductions);
        System.out.printf("-----------------------------------------------%n");
    ...
    public static double compute_sss()
    {
        ...
        double rate = 157.5;
        double rrate = 0;
        // not in the beginning and end, it must be in the inside
